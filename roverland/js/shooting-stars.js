(function () {
  ...
  var background2 = document.getElementById("bgCanvas2"),
  ...
  bgCtx2.fillStyle = '#05004c';
  bgCtx2.fillRect(0, 0, width, height);
  ...
  ShootingStar.prototype.update = function () {
    if (this.active) {
      ...
      if (this.x < 0 || this.y >= height) {
        ...
        bgCtx2.lineWidth = this.size;
        bgCtx2.beginPath();
        bgCtx2.moveTo(this.x, this.y);
        bgCtx2.lineTo(this.x + this.len, this.y - this.len);
        bgCtx2.stroke();
      }
    } else {
